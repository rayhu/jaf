...
**Descripción**
Este programa proporciona a personas y familias de bajos ingresos en California acceso a educación legal, información procesal y servicios de derivación relacionados con el arrendamiento residencial, los procedimientos de desahucio y los procesos administrativos relacionados con la vivienda. El programa no constituye representación legal.
...
- El personal y los voluntarios que proporcionan información están sujetos a limitaciones escritas del alcance del servicio
...
Este programa proporciona únicamente servicios educativos e informativos. Ningún participante será dirigido a ningún proveedor de servicios comerciales como condición para recibir servicios caritativos. Todas las derivaciones son a organizaciones legales sin fines de lucro con licencia o a abogados con licencia vigente.
...
**Descripción**
Este programa asiste a trabajadores en California que han experimentado robo salarial, horas extra no pagadas, deducciones ilegales de nómina u otras violaciones de las leyes de salarios y horas del estado y federales. El programa proporciona educación legal, orientación procesal y derivaciones a recursos apropiados de aplicación o asistencia legal.
...
- No se hace ninguna representación de que JAF pueda recuperar salarios o representar a trabajadores en procedimientos
- No existe relación de derivación o financiera con ningún servicio comercial de personal, nómina o del lado del empleador

**Límites de Cumplimiento**
Este programa proporciona únicamente servicios educativos, informativos y de derivación. La participación en este programa no constituye una relación abogado-cliente, y JAF o su personal no proporcionan representación legal.
...
**Descripción**
Este programa asiste a personas en California que deben navegar procedimientos del tribunal civil sin representación legal (litigantes que se representan a sí mismos). Proporciona información procesal, orientación para completar formularios y asistencia para navegar en procedimientos administrativos y judiciales. Este programa no proporciona asesoramiento legal.

**Población Objetivo**
Litigantes que se representan a sí mismos en los tribunales civiles de California, incluyendo personas involucradas en casos de reclamaciones menores, desahucio, procedimientos limitados de derecho de familia y audiencias administrativas.
...
- Todos los proveedores de servicios están capacitados en la distinción entre información legal y asesoramiento legal

**Límites de Cumplimiento**
JAF no proporciona representación legal ni asesoramiento legal. Este programa no crea una relación abogado-cliente. Se alienta a los participantes a buscar asesoramiento legal con licencia para asuntos que requieran juicio legal profesional.
...
**Descripción**
Este programa produce y difunde información legal en lenguaje claro en múltiples idiomas — incluyendo inglés, español y chino simplificado — para apoyar la capacidad de los residentes de California de comprender sus derechos legales y obligaciones cívicas dentro de los sistemas legales estatales y federales.

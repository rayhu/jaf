...
**Description**
This program provides low-income individuals and families in California with access to legal education, procedural information, and referral services related to residential tenancy, unlawful detainer proceedings, and housing-related administrative processes. The program does not constitute legal representation.
...
This program provides educational and informational services only. No participant will be directed to any commercial service provider as a condition of receiving charitable services. All referrals are to licensed nonprofit legal organizations or licensed attorneys.
...
**Compliance Boundaries**
This program provides educational, informational, and referral services only. Participation in this program does not constitute an attorney-client relationship, and no legal representation is provided by JAF or its staff.
...
**Compliance Boundaries**
JAF does not provide legal representation or legal advice. This program does not create an attorney-client relationship. Participants are encouraged to seek licensed legal counsel for matters requiring professional legal judgment.
...
**Description**
This program produces and disseminates plain-language legal information in multiple languages — including English, Spanish, and Chinese (Simplified) — to support the ability of California residents to understand their legal rights and civic obligations within the state and federal legal systems.
